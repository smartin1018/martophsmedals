...
public class GUI {
    ...
    private static Inventory getMedalInventory(Player player, int page) {
        ...
        for (Medal medal : subMedals) {
            ...
            medalItemMeta.setDisplayName(medal.getDisplay().replace("&", "§"));
    ...
    static void sendMedalInventory(Player player) {
    ...
    static void sendMedalInventory(Player player, int page) {
